...
class TestFindDirectionField(unittest.TestCase):
    ...
    def test_find_circumference(self):
        ...
        circumference = find_valid_circumference(np.array([3, 0], dtype=np.int64), map.playable_fields, 1)
    ...
    def test_find_circumference1(self):
        ...
        circumference = find_valid_circumference(np.array([0, 0], dtype=np.int64), map.playable_fields, 1)
    ...
    def test_find_circumference2(self):
        ...
        circumference = find_valid_circumference(np.array([4, 7], dtype=np.int64), map.playable_fields, 1)
    ...
    def test_find_circumference3(self):
        ...
        circumference = find_valid_circumference(np.array([4, 4], dtype=np.int64), map.playable_fields, 2)
    ...
    def test_find_circumference4(self):
        ...
        circumference = find_valid_circumference(np.array([4, 4], dtype=np.int64), map.playable_fields, 0)

        self.assertEqual(len(circumference), 1)
        npt.assert_array_equal(circumference[0], np.array([4, 4]))

    def test_find_circumference_accepts_int16_position(self):
        map = Map(6, 8)

        circumference = find_valid_circumference(np.array([4, 4], dtype=np.int16), map.playable_fields, 0)

        self.assertEqual(len(circumference), 1)
        npt.assert_array_equal(circumference[0], np.array([4, 4], dtype=np.int16))
        self.assertEqual(circumference[0].dtype, np.int16)

    def test_find_circumference_accepts_int32_position(self):
        map = Map(6, 8)

        circumference = find_valid_circumference(np.array([4, 4], dtype=np.int32), map.playable_fields, 0)

        self.assertEqual(len(circumference), 1)
        npt.assert_array_equal(circumference[0], np.array([4, 4], dtype=np.int32))
        self.assertEqual(circumference[0].dtype, np.int32)
