...
class TestFindDirectionField(unittest.TestCase):
    ...
    def test_find_direction_field7(self):
        ...
        npt.assert_array_equal(next_field, np.array([3,3]))
    ...
    def test_find_direction_field9(self):
        ...
        npt.assert_array_equal(next_field, np.array([0,0]))

    def test_find_direction_field10(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(2, np.array([1, 1]))
        npt.assert_array_equal(next_field, np.array([0,1]))
    ...
    def test_find_direction_field_invalid1(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(0, np.array([2, 0]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))

    def test_find_direction_field_invalid2(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(3, np.array([2, 9]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))

    def test_find_direction_field_invalid3(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(1, np.array([1, 0]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))

    def test_find_direction_field_invalid4(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(5, np.array([1, 0]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))

    def test_find_direction_field_invalid5(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(2, np.array([2, 9]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))

    def test_find_direction_field_invalid6(self):
        map = Map(10, 8)
        next_field = map.find_direction_field(4, np.array([2, 9]))
        npt.assert_array_equal(next_field, np.array([-1,-1]))
