...
class TestCommand(unittest.IsolatedAsyncioTestCase):
    async def test_command_error1(self):
        ...
        with self.assertRaises(InvalidCommandError) as error:
            await game.command(unit_index=0, command_type=CommandType.DOWN_LEFT, is_red_command=True, on_winning=None)
    ...
    async def test_command_error2(self):
        game = ChasingGameBase(initialize=make_initialize_mock(np.array([[0, 0],[1, 1]])), command=command)
        with self.assertRaises(InvalidCommandError) as error:
            await game.command(unit_index=1, command_type=CommandType.DOWN_LEFT, is_red_command=False, on_winning=None)
    ...
    async def test_command_quiet(self):
        game = ChasingGameBase(initialize=make_initialize_mock(np.array([[0, 0],[1, 1]])), command=command)
        await game.command(unit_index=0, command_type=CommandType.QUIET, is_red_command=False, on_winning=None)
    ...
    async def test_command_error4(self):
        ...
        with self.assertRaises(InvalidCommandError) as error:
            await game.command(unit_index=0, command_type=CommandType.UP_LEFT, is_red_command=False, on_winning=None)
        self.assertEqual(str(error.exception), "Movement outside of board")

    async def test_command_1(self):
        game = ChasingGameBase(initialize=make_initialize_mock(np.array([[0, 0],[1, 1]])), command=command)
        await game.command(unit_index=0, command_type=CommandType.RIGHT, is_red_command=False, on_winning=None)
    ...
    async def test_several_commands(self):
        ...
        for number in random_numbers:
            try:
                ...
                await game.command(unit_index=0, command_type=CommandType(number), is_red_command=is_red_command, on_winning=None)
                ...
                await game.command(unit_index=0, command_type=CommandType.QUIET, is_red_command=is_red_command, on_winning=None)
    ...
    async def test_combat1(self):
        ...
        await game.command(unit_index=0, command_type=CommandType.LEFT, is_red_command=False, on_winning=None)
    ...
    async def test_combat2(self):
        ...
        edited_units = await game.command(unit_index=0, command_type=CommandType.LEFT, is_red_command=False, on_winning=None)
    ...
    async def test_win1(self):
        ...
        await game.command(unit_index=0, command_type=CommandType.RIGHT, is_red_command=False, on_winning=make_on_winning({}))
        with self.assertRaises(InvalidCommandError) as error:
            await game.command(unit_index=0, command_type=CommandType.LEFT, is_red_command=True, on_winning=make_on_winning({}))
        self.assertEqual(str(error.exception), "A command was receive after the win")
